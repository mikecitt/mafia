...
import { getPartyCode, getPartySnapshot, startGame } from "@/lib/game";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      {
        error:
          error instanceof Error ? error.message : "Pokretanje partije nije uspelo.",
      },
      { status: 400 },
    );
  }
